...
class DownloadDocumentVersionScenario extends Scenario
{
    ...
    function run()
    {
        ...
        file_put_contents("resources/downloads/documentVersion.pdf", $documentVersion);
        ...
        file_put_contents("resources/downloads/documentVersionBytes.pdf", base64_decode($documentVersionBytes["bytes"]));
